    ...
    <div className="flex flex-col flex-grow items-center pt-6">
      ...
      >
        <div className="flex w-full items-center justify-between">
          <p className="font-semibold text-gray-600 pl-2 pt-1 pb-3">Create Pool</p>
          <img onClick={()=>setCreatePool(false)} src={cross}
        ...
        <button onClick={available === 0 ? onCreatePool : available === 2 ? onConnectWallet : (event)=>event.preventDefault()}
