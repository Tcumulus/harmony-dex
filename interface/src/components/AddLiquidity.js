...
const AddLiquidity = ({ roundBalance, setAddLiquidity}) => {
    ...
    <div className="flex flex-col flex-grow items-center pt-6">
      ...
      >
        <div className="flex w-full items-center justify-between pl-2 pt-1 pb-3">
          <p className="font-semibold text-gray-600">Add Liquidity</p>
          <button onClick={()=>setAddLiquidity(false)} 
      ...
      { amountA ? 
        <div className="flex-col w-80 z-0 bg-white rounded-b-xl">
          ...
          <div className="flex justify-between mt-2 mb-3">
            ...
            <p className="mx-4 font-semibold text-gray-600">11.3%</p>
          </div>
        </div>
      : null }
